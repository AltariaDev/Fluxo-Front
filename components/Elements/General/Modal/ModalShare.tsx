...
export default function ShareModal({
  ...
  return (
    <div className="fixed left-0 top-0 w-full h-full flex items-center justify-center z-60 bg-black/25">
      <div className="w-[600px] bg-background-primary rounded-lg p-6 flex flex-col items-end gap-4 drop-shadow-2xl">
        <div className="flex flex-col gap-2 w-full">
          <p className="text-sm text-gray-500">
            Comparte este enlace para que otros puedan unirse a tu sesión de
            Pomodoro:
          </p>
