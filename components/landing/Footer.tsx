...
export default function Footer() {
  return (
    <footer
      className="bg-gradient-to-b from-primary-500 to-primary-800"
    ...
    >
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
              ...
              <div>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  <li>
                    <Link
                      href="#inicio"
                      className="text-base text-primary-200 hover:text-white transition-colors"
                    >
                      Inicio
                    </Link>
                  </li>
        ...
        <div className="mt-12 border-t border-primary-800 pt-8">
          <p className="text-base text-primary-200 xl:text-center">
