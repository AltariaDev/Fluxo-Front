  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-primary-500">
      <div className="flex items-center justify-center flex-1">
        <div className="bg-[linear-gradient(117deg,_rgba(120,_198,_163,_0.25)_8.54%,_rgba(120,_198,_163,_0.20)_48.97%,_rgba(120,_198,_163,_0.15)_92.62%)] rounded-lg border-2 border-[rgba(120,198,163,0.52)] backdrop-blur-lg p-10 w-4/5 text-center">
